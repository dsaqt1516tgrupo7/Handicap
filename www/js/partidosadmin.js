...
var API_BASE_URL_DELETE = 'http://localhost:8080/handicap-api/partidos/team/';
...
function PartidoCollection(partidoCollection, respuesta, partidos){
	...
	this.toHTML = function(){
		...
		$.each(this.partidos, function(i, v) {
			...
			'<FONT class="texts" color="#F78A0E"><strong> ID: </strong> </FONT><FONT color="#FFFFFF">' + idpartido+ '</FONT><br>' +
			...
			html = html.concat('<br>');
			html = html.concat('<a class="boton verde" href="comentariosadmin.html" onclick="getPartido('+idpartido+')" id="anuncio" align=left>Entrar al Partido</a><br>');
			html = html.concat('<a class="boton verde" href="partidosadmin.html" onclick="deletePartido('+idpartido+')" id="eliminar" align=left>Eliminar Partido</a><br>');
			html = html.concat('<a class="boton verde" href="partidosadmin.html" onclick="getAnuncio('+idpartido+')" id="cerrar" align=left>Entrar a los Picks</a><br>');
			html = html.concat('<a class="boton verde" href="partidosadmin.html" onclick="updatePartido('+idpartido+')" id="modificar" align=left>Modificar Partido</a><br>');
			html = html.concat('<br>');
...
function updatePartido(i) {
	window.location= "adminupdate.html";
	pasarVariables ('adminupdate.html',i);
	$('adminupdate.html').ready(function(){
	});
}
...
function getPrincipio(){
	...
	pasarVariables ('partidosadmin.html');
...
function deletePartido(i) {
	var url = API_BASE_URL_DELETE + i;
	$.ajax({			
		url : url,
		type : 'DELETE',
		crossDomain : true,
